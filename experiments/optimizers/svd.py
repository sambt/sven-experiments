...
def build_svd_optimizer(
    ...
    **_,
    ...
    """
    Wrap a base model with FunctionalModelJac and return the SVD optimizer.
    """
    loss_fn = loss_fn or mse_loss
    fn_model = FunctionalModelJac(
    ...
    optimizer = SVDOptimizer(fn_model, lr=lr, k=k, rtol=rtol, track_svd_info=track_svd_info)
