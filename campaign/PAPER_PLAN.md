...
| F13 | `figures_iclr/main/allseed_curves.pdf` | 3×2 @0.48 | main | App. E | `headline_figs.curve_figure` (epoch, time) | confirmation-seed mean ± 1 std for 1D / polynomial / MNIST-LR on two axes; `allseed_curves_nosoap` is the same figure with SOAP dropped. **Replaces Fig. 3** (`figures_v2/*_allSeeds/*`) |
