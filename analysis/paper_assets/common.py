...
Read ``analysis/paper_assets/README.md`` and ``analysis/paper_assets/README.md`` first.  The rules
...
#: command of ``analysis/paper_assets/README.md`` regenerates the campaign totals too.
...
def write_numbers_index(path=None, modules=MODULES, present_only=True):
    ...
    lines = ['% numbers_v2.tex -- GENERATED by analysis/paper_assets.  Do not edit by hand.',
             ...
             '% one of the files below (analysis/paper_assets/README.md: numbers are never typed).',
             f'% generated: {_now()}',
             '%']
...
def booktabs(rows, columns=None, align=None, caption=None, label=None,
    ...
    placement can be tuned (``analysis/paper_assets/README.md`` risk 9: ``\\color{blue}`` inside a float
    ...
    # package, which the manuscript does not load and which analysis/paper_assets/README.md section 6 forbids
