...
``analysis/paper_assets/README.md`` section 5.4 names the shared-conventions module ``_common.py``
and the plan named it ``common.py``.  The module itself is ``common.py``; this
