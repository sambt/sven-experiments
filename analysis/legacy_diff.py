...
``analysis/legacy_vs_fresh.ipynb``; the written account is ``analysis/WHAT_CHANGED.md``.
...
run recorded.  Regenerate a missing parquet with::
    ...
    campaign/run_cpu_tests.sh .venv/bin/python analysis/repair_legacy.py <scan> \\
